...
class ytDevice extends Device {
    ...
    async onInit() {
        ...
        try {
            ...
            if (settings && settings.feedUrl) {
                this.feedUrl = `https://www.youtube.com/feeds/videos.xml?channel_id=${settings.feedUrl}`;
    ...
    onSettings({ oldSettings, newSettings, changedKeys }) {
        if (changedKeys.includes('feedUrl')) {
            this.feedUrl = `https://www.youtube.com/feeds/videos.xml?channel_id=${newSettings.feedUrl}`;
